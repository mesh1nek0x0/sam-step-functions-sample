...
This is a sample template for sam-step-functions-sample - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name sam-step-functions-sample \
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-step-functions-sample --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-step-functions-sample
```
